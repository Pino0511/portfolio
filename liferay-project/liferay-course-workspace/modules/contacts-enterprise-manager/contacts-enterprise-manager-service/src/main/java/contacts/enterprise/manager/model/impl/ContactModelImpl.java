...
import contacts.enterprise.manager.model.ContactModel;
...
/**
 * The base model implementation for the Contact service. Represents a row in the &quot;CEM_Contact&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
...
public class ContactModelImpl
	 ...
	 */
	public static final String TABLE_NAME = "CEM_Contact";
	...
	public static final Object[][] TABLE_COLUMNS = {
		...
		{"phoneNumber", Types.VARCHAR}, {"company", Types.VARCHAR},
		{"jobTitle", Types.VARCHAR}, {"notes", Types.VARCHAR},
	...
	static {
		...
		attributeGetterFunctions.put("company", Contact::getCompany);
		attributeSetterBiConsumers.put(
			"company", (BiConsumer<Contact, String>)Contact::setCompany);
		attributeGetterFunctions.put("jobTitle", Contact::getJobTitle);
		attributeSetterBiConsumers.put(
			"jobTitle", (BiConsumer<Contact, String>)Contact::setJobTitle);
		attributeGetterFunctions.put("notes", Contact::getNotes);
		attributeSetterBiConsumers.put(
			"notes", (BiConsumer<Contact, String>)Contact::setNotes);
		attributeGetterFunctions.put("active", Contact::getActive);
		attributeSetterBiConsumers.put(
			"active", (BiConsumer<Contact, Boolean>)Contact::setActive);
	...
	public Object clone() {
		...
		contactImpl.setCompany(getCompany());
		contactImpl.setJobTitle(getJobTitle());
		contactImpl.setNotes(getNotes());
		contactImpl.setActive(isActive());
	...
	public Contact cloneWithOriginalValues() {
		...
		contactImpl.setGroupId(this.<Long>getColumnOriginalValue("groupId"));
		...
		contactImpl.setCompany(this.<String>getColumnOriginalValue("company"));
		contactImpl.setJobTitle(
			this.<String>getColumnOriginalValue("jobTitle"));
		contactImpl.setNotes(this.<String>getColumnOriginalValue("notes"));
		contactImpl.setActive(this.<Boolean>getColumnOriginalValue("active_"));
	...
	public CacheModel<Contact> toCacheModel() {
		...
		contactCacheModel.company = getCompany();

		String company = contactCacheModel.company;

		if ((company != null) && (company.length() == 0)) {
			contactCacheModel.company = null;
		}
		...
		contactCacheModel.notes = getNotes();

		String notes = contactCacheModel.notes;

		if ((notes != null) && (notes.length() == 0)) {
			contactCacheModel.notes = null;
		}

		contactCacheModel.active = isActive();
	...
	static {
		...
		columnBitmasks.put("jobTitle", 4096L);
