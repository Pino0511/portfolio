...
public class ContactLocalServiceWrapper
	 ...
	 */
	@Override
	public contacts.enterprise.manager.model.Contact addContact(
		contacts.enterprise.manager.model.Contact contact) {
	...
	public contacts.enterprise.manager.model.Contact addContact(
			...
			String email, String phoneNumber, String company, String jobTitle,
			String notes, boolean active,
			com.liferay.portal.kernel.service.ServiceContext serviceContext)
		throws com.liferay.portal.kernel.exception.PortalException {

		return _contactLocalService.addContact(
			userId, groupId, firstName, lastName, email, phoneNumber, company,
			jobTitle, notes, active, serviceContext);
	}
	 ...
	 */
	@Override
	public contacts.enterprise.manager.model.Contact createContact(
		long contactId) {
	 ...
	 */
	@Override
	public contacts.enterprise.manager.model.Contact deleteContact(
		contacts.enterprise.manager.model.Contact contact) {
	...
	@Override
	public contacts.enterprise.manager.model.Contact fetchContact(
		long contactId) {
	 ...
	 */
	@Override
	public contacts.enterprise.manager.model.Contact getContact(long contactId)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	@Override
	public java.util.List<contacts.enterprise.manager.model.Contact>
	...
	public java.util.List<contacts.enterprise.manager.model.Contact>
		searchAdvanced(
			...
			String jobTitle, int start, int end,
			com.liferay.portal.kernel.util.OrderByComparator
				<contacts.enterprise.manager.model.Contact> orderByComparator) {

		return _contactLocalService.searchAdvanced(
			groupId, firstName, lastName, company, jobTitle, start, end,
			orderByComparator);
	}

	@Override
	public int searchAdvancedCount(
		long groupId, String firstName, String lastName, String company,
		String jobTitle) {

		return _contactLocalService.searchAdvancedCount(
			groupId, firstName, lastName, company, jobTitle);
	}

	@Override
	public java.util.List<contacts.enterprise.manager.model.Contact>
		searchGroupContacts(long groupId, String keywords, int start, int end) {

		return _contactLocalService.searchGroupContacts(
			groupId, keywords, start, end);
	}

	@Override
	public int searchGroupContactsCount(long groupId, String keywords) {
		return _contactLocalService.searchGroupContactsCount(groupId, keywords);
	}
	 ...
	 */
	@Override
	public contacts.enterprise.manager.model.Contact updateContact(
		contacts.enterprise.manager.model.Contact contact) {
	...
	@Override
	public contacts.enterprise.manager.model.Contact updateContactEntry(
			contacts.enterprise.manager.model.Contact contact)
		throws com.liferay.portal.kernel.exception.PortalException {

		return _contactLocalService.updateContactEntry(contact);
	}
