 ...
 * <code>contacts.enterprise.manager.service.impl.ContactLocalServiceImpl</code> and
...
public class ContactLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>contacts.enterprise.manager.service.impl.ContactLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	...
	public static List<Contact> searchAdvanced(
		long groupId, String firstName, String lastName, String company,
		String jobTitle, int start, int end,
		OrderByComparator<Contact> orderByComparator) {

		return getService().searchAdvanced(
			groupId, firstName, lastName, company, jobTitle, start, end,
			orderByComparator);
	}

	public static int searchAdvancedCount(
		long groupId, String firstName, String lastName, String company,
		String jobTitle) {

		return getService().searchAdvancedCount(
			groupId, firstName, lastName, company, jobTitle);
	}

	public static List<Contact> searchGroupContacts(
		long groupId, String keywords, int start, int end) {

		return getService().searchGroupContacts(groupId, keywords, start, end);
	}

	public static int searchGroupContactsCount(long groupId, String keywords) {
		return getService().searchGroupContactsCount(groupId, keywords);
	}
	...
	public static Contact updateContactEntry(Contact contact)
		throws PortalException {

		return getService().updateContactEntry(contact);
	}
